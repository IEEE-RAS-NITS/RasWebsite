        ...
        >
          ...
          >
            <span className="relative flex h-2 w-2">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#FF9A5C] opacity-75"></span>
              <span className="relative inline-flex rounded-full h-2 w-2 bg-[#FF9A5C]"></span>
            </span>
          ...
          <motion.div {...fadeIn} className="space-y-8">
            <p className="text-lg md:text-xl text-white/70 leading-relaxed max-w-2xl mx-auto">
              The IEEE RAS NIT Silchar learning repository is currently being
              curated with localized tutorials and research materials.
            </p>

            {/* External Resource Card */}
            <div className="bg-black/20 border border-white/10 rounded-2xl p-8 max-w-2xl mx-auto backdrop-blur-md">
              {/* ✅ "Immediate Resources" now in IEEE blue-teal */}
              <h3 className="text-sm font-bold uppercase tracking-[0.2em] text-[#00A8E8] mb-4">
                Immediate Resources
              </h3>
              <p className="text-white/80 text-base mb-6">
                In the meantime, explore the global technical library and
                educational modules provided by the parent society.
              </p>
              <Link
                href="https://www.ieee-ras.org/ras-university/"
                target="_blank"
                className="inline-flex items-center gap-3 bg-white text-black px-8 py-4 rounded-full font-bold uppercase tracking-widest text-xs hover:bg-[#006699] hover:text-white transition-all duration-300 group"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4">
              {[
                ...
                <div
                  key={i}
                  className="bg-white/5 border border-white/10 p-6 rounded-2xl hover:border-[#00A8E8]/30 hover:bg-white/8 transition-all duration-300"
                >
